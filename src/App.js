...
const App = () => {
  ...
  const [expenses, setExpenses] = useState([
    ...
    {id: 2, charge: "transportation", amount: 400},
    {id: 3, charge: "food", amount: 300 }
  ])
  ...
  const handleSubmit = (e) => {
    ...
    if (charge !== '' && amount > 0){
      if(edit){
        ...
        setExpenses(newExpenses)
        setEdit(false)
        setAlert({type: 'success', text: '아이템이 수정되었습니다.'})
      }else{
      ...
      handleAlert({
        type: 'danger',
        text: 'charge 는 빈 값일 수 없으며 amount 는 0보다 커야 합니다.'
      })
    }
  }
  ...
  return(
    <main className="main-container">
      ...
      <div style={{width: '100%', backgroundColor: 'white', padding: '1rem'}}>
        ...
        handleAmount = {handleAmount} amount = {amount} handleSubmit={handleSubmit} edit = {edit} />
      </div>
